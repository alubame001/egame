...
/*
<~timesince .Lang .Article.Created~>
*/
func timesince(lang string, t time.Time) string {
	fmt.Printf(beego.Date(t, setting.DateFormat))
...
/*
<~checksection .Nickname ~>
*/
func checksection(section bool) string {
	if section {
		return ""
	} else {
		return "hide"
...
func init() {
	...
	beego.AddFuncMap("checksection", checksection)
