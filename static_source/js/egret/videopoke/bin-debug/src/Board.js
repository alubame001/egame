...
var Board = (function (_super) {
    ...
    Board.prototype.createView = function () {
        ...
        this.spr.graphics.drawRect(0, 0, 440, 480);
        ...
        this.cureScoreTF.x = 215;
        this.cureScoreTF.y = 40;

        // this.cureScoreTF.textColor = 0x000000;
        this.cureScoreTF.text = "00秒";
        ...
        this.shareBtn.x = this.spr.width / 2 - this.shareBtn.width / 2 + 8;
        this.shareBtn.y = 220;
        ...
        this.retryBtn.x = this.spr.width / 2 - this.retryBtn.width / 2 + 8;
        this.retryBtn.y = 300;
    ...
    Board.prototype.onRetryBtnTouchTap = function (e) {
        this.dispatchEvent(new egret.Event("onRetry1"));
    };
    Board.prototype.setScore = function (score) {
        this.cureScoreTF.text = "" + score + "秒";
    };
    Board.prototype.setMaxScore = function (score) {
        this.bestCoreTF.text = "" + score + "秒";
    };
