...
var ERpgslot = (function (_super) {
    __extends(ERpgslot, _super);
    ...
    */
    function ERpgslot(context, imgName, backFun, descStr, fontSize, cartoonType, assetsName) {
        ...
        _super.call(this);
        this.assets = RES.getRes("gem6"); //名称不一样的话需要修改
     ...
     */
    ERpgslot.prototype.init = function (imgName, backFun, descStr, fontSize, cartoonType, assetsName) {
        if (backFun === void 0) { backFun = null; }
        if (descStr === void 0) { descStr = ""; }
        if (fontSize === void 0) { fontSize = 30; }
        if (cartoonType === void 0) { cartoonType = 1; }
    ...
    ERpgslot.prototype.onbuttonTouchTap = function (e) {
    ...
    //设置绑定数据
    ERpgslot.prototype.setBindData = function (data) {
        this.param.data = data;
    };
    //获取绑定数据
    ERpgslot.prototype.getBindData = function () {
        return this.param.data;
    };
    ERpgslot.prototype.getBitmap = function () {
        return this.btnImg;
    };
    ERpgslot.prototype.setBitmap = function (newImgName) {
        this.btnImg.texture = this.assets.getTexture(newImgName);
        // console.log(newImgName);
        this.addChild(this.btnImg);
    };
    ERpgslot.prototype.setScale = function (x, y) {
        this.scaleXSize = x;
        this.scaleYSize = y;
        egret.Tween.get(this).to({ scaleX: x, scaleY: y }, 0, egret.Ease.elasticOut);
    };
    ERpgslot.prototype.setIsRunning = function (result) {
        this.isRunning = result;
    };
    ERpgslot.prototype.getImageName = function (imgIndex, isBlur) {
        if (isBlur) {
    ...
    ERpgslot.prototype.setRandomImg = function (isBlur) {
...
ERpgslot.prototype.__class__ = "ERpgslot";
