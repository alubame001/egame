...
var Lottery28Panel = (function (_super) {
    __extends(Lottery28Panel, _super);
    function Lottery28Panel() {
        _super.call(this);
        /* ↓↓↓↓↓↓↓↓↓↓↓↓↓↓是引用此class需修改的*/
    ...
    Lottery28Panel.prototype.setStake = function (odd) {
        return Math.round(this.min_bet / odd * 100) / 100 * this.min_bet * 10;
    };
    Lottery28Panel.prototype.betMode = function (n) {
        switch (n) {
            case 1:
                for (var i = 14; i < 28; i++) {
    ...
    */
    Lottery28Panel.prototype.showResult = function (str) {
        this.isPlay = false;
...
Lottery28Panel.prototype.__class__ = "Lottery28Panel";
