...
var TitanSlotPanel = (function (_super) {
    __extends(TitanSlotPanel, _super);
    function TitanSlotPanel() {
        _super.call(this);
        /* ↓↓↓↓↓↓↓↓↓↓↓↓↓↓是引用此class需修改的*/
    ...
    TitanSlotPanel.prototype.initPanel = function () {
        this.bg = new egret.Bitmap();
        this.bg.texture = RES.getRes("darkslot_bg");
        this.addChild(this.bg);
        this.bg.touchEnabled = false;
        this.slot1 = new EButton(this, "i1", null, "", 20, 4, "titan");
        this.slot1.x = 10;
        this.slot1.y = 10;
    ...
    TitanSlotPanel.prototype.onChooseStage = function (e) {
        this.disconnenct();
        Global.dispatchEvent(MainNotify.openStartPanelNotify, null, false);
        Global.dispatchEvent(MainNotify.closeTitanSlotPanelNotify, null, false);
    };
    return TitanSlotPanel;
})(GamePanel);
TitanSlotPanel.prototype.__class__ = "TitanSlotPanel";
