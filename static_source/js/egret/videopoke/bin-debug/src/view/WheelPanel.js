...
var WheelPanel = (function (_super) {
    ...
    function WheelPanel() {
        ...
        this.slotNumber = 12;
        this.game_cname = "十二生肖";
        this.game_ename = "Chinese Zodiac";
        this.game_kind = "wheel";
        this.myBet = { name: "slot", kind: this.game_kind, total: 0, lucky: "", shash: "", nonce: "", ckey: "", pick: [], pk: [] };
    }
    /* ↑↑↑↑↑↑↑↑↑↑↑↑是引用此class需修改的*/
    WheelPanel.prototype.onImgBtnTouchTap = function (e) {
...
WheelPanel.prototype.__class__ = "WheelPanel";
