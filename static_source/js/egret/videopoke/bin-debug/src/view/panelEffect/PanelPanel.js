...
var PanelPanel = (function (_super) {
    ...
    // 初始化面板
    PanelPanel.prototype.initPanel = function () {
    ...
    PanelPanel.prototype.initEffect = function () {
    ...
    PanelPanel.prototype.onbtn1TouchTap = function (e) {
    ...
    PanelPanel.prototype.onbtn2TouchTap = function (e) {
        if (GlobalData.isEngineer) {
    ...
    PanelPanel.prototype.onbtn3TouchTap = function (e) {
        if (GlobalData.isEngineer) {
    ...
    PanelPanel.prototype.onbtn4TouchTap = function (e) {
        if (GlobalData.isEngineer) {
    ...
    PanelPanel.prototype.onbtn5TouchTap = function (e) {
        if (GlobalData.isEngineer) {
    ...
    PanelPanel.prototype.onbtn6TouchTap = function (e) {
        if (GlobalData.isEngineer) {
    ...
    PanelPanel.prototype.onbtn7TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    PanelPanel.prototype.onbtn8TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    PanelPanel.prototype.onbtn9TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    PanelPanel.prototype.onbtn10TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    PanelPanel.prototype.onMenuBtnTouchTap = function () {
        Global.dispatchEvent(MainNotify.openStartPanelNotify, null, false);
        Global.dispatchEvent(MainNotify.closePanelPanelNotify, null, false);
    };
    PanelPanel.prototype.onSetBtnTouchTap = function (e) {
