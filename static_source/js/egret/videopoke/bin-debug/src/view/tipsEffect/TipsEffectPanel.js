...
var TipsEffectPanel = (function (_super) {
    __extends(TipsEffectPanel, _super);
    function TipsEffectPanel() {
        _super.call(this);
    }
    // 初始化提示
    TipsEffectPanel.prototype.initPanel = function () {
...
*/
    ...
    TipsEffectPanel.prototype.initEffect = function () {
    ...
    TipsEffectPanel.prototype.onbtn1TouchTap = function (e) {
        if (GlobalData.isEngineer) {
        }
    };
    TipsEffectPanel.prototype.onbtn2TouchTap = function (e) {
        if (GlobalData.isEngineer) {
        }
    };
    TipsEffectPanel.prototype.onbtn3TouchTap = function (e) {
        if (GlobalData.isEngineer) {
        }
    };
    TipsEffectPanel.prototype.onbtn4TouchTap = function (e) {
        // if(GlobalData.isEngineer){
        // Global.alert("用法",'TipsManager.addTips(this.btn4,"从右向左",3); ',null,1);
        //}  
    };
    TipsEffectPanel.prototype.onbtn5TouchTap = function (e) {
    };
    TipsEffectPanel.prototype.onbtn6TouchTap = function (e) {
    };
    TipsEffectPanel.prototype.onbtn7TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    TipsEffectPanel.prototype.onbtn8TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    TipsEffectPanel.prototype.onbtn9TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    TipsEffectPanel.prototype.onbtn10TouchTap = function (e) {
        // Global.alert("提示","我是一个提示栗子，哈哈",null,6);
    };
    TipsEffectPanel.prototype.onMenuBtnTouchTap = function () {
        Global.dispatchEvent(MainNotify.openStartPanelNotify, null, false);
        Global.dispatchEvent(MainNotify.closePanelPanelNotify, null, false);
    };
    TipsEffectPanel.prototype.onSetBtnTouchTap = function (e) {
        Global.dispatchEvent(MainNotify.openSetPanelNotify, 2, false);
    };
    return TipsEffectPanel;
})(BasePanel);
TipsEffectPanel.prototype.__class__ = "TipsEffectPanel";
