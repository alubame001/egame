...
module TipsUtils {
    ...
    //从下到上弹出
    export function showTipsDownToUp(str:string = "",isWarning:boolean = false,x:number=0,y:number=0):void{
        ...
        egret.Tween.get(effectTips).to({y:effectTips.y - 20,alpha:1},800,egret.Ease.backOut).call(onComplete1,this);   
    }    
