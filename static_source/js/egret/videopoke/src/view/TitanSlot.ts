...
class TitanSlotPanel extends     GamePanel{
...
/* ↑↑↑↑↑↑↑↑↑↑↑↑是引用此class需修改的*/
   ...
   // public imgSlot2_bottom: EButton; //
    ...
    private eBackGround:EButton;   
    private slot1:EButton;   
    private slot2:EDarkSlot;   
    private slot3:EDarkSlot;   


    public frame1: EButton;
    public frame2: EButton;
    public frame3: EButton;
