...
function setChannel(newParam) {
	...
	$('.show').show().fadeIn(5000)
          ...
          case 2: 
            ...
            $(".images").show()
            $(".image2").fadeIn(1000)
            $(".channel2").append('<embed class="show" src="http://yy.com/s/90066/mini.swf" quality="high" width="1000" height="500" align="middle" allowScriptAccess="never" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>')
            $(".images").hide(1000) 
          ...
          case 3: 
            ...
            $(".images").show()
            $(".image4").fadeIn(1000)
            $(".channel3").append('<embed class="show" src="http://yy.com/s/90066/mini.swf" quality="high" width="1000" height="500" align="middle" allowScriptAccess="never" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>')
            $(".images").hide(1000) 
          ...
          case 4: 
            ...
            $(".images").show()
            $(".image4").fadeIn(1000)
            $(".channel4").append('<embed class="show" src="http://yy.com/s/90066/mini.swf" quality="high" width="1000" height="500" align="middle" allowScriptAccess="never" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>')
            $(".images").hide(2000) 
