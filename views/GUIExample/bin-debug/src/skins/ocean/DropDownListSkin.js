...
(function (skins) {
    ...
    (function (ocean) {
        var DropDownListSkin = (function (_super) {
            ...
            function DropDownListSkin() {
                ...
                this.states = [
                    ...
                    new egret.gui.State("open", [
                        new egret.gui.SetProperty("labelDisplay", "textColor", 0xeeeeee),
            ...
            DropDownListSkin.prototype.__5_i = function () {
            ...
            DropDownListSkin.prototype.dataGroup_i = function () {
                ...
                this.dataGroup = t;
                this.__s(t, ["percentHeight", "itemRendererSkinName", "percentWidth"], [100, skins.ocean.DropDownListItemRendererSkin, 100]);
                t.layout = this.__5_i();
                return t;
            };
            DropDownListSkin.prototype.dropDown_i = function () {
                ...
                t.elementsContent = [this.__4_i(), this.scroller_i()];
                return t;
            };
            DropDownListSkin.prototype.labelDisplay_i = function () {
                var t = new egret.gui.Label();
                this.labelDisplay = t;
                this.__s(t, ["fontFamily", "paddingLeft", "touchChildren", "touchEnabled", "verticalAlign", "verticalCenter"], ["Tahoma", 10, false, false, "middle", -2]);
                return t;
            };
            DropDownListSkin.prototype.openButton_i = function () {
                var t = new egret.gui.Button();
                this.openButton = t;
                this.__s(t, ["percentHeight", "skinName", "percentWidth"], [100, skins.ocean.DropDownListOpenButtonSkin, 100]);
                return t;
            };
            ...
            DropDownListSkin.prototype.__4_i = function () {
                ...
                this.__s(t, ["bottom", "left", "right", "source", "top"], [-8, -7, -7, "dropdownlist_dropback_png", -8]);
                return t;
            };
            DropDownListSkin._skinParts = ["openButton", "labelDisplay", "dataGroup", "scroller", "dropDown", "popUp"];
            return DropDownListSkin;
        })(egret.gui.Skin);
        ocean.DropDownListSkin = DropDownListSkin;
        DropDownListSkin.prototype.__class__ = "skins.ocean.DropDownListSkin";
